...
public class TiendaGeometricaPolimorfismo extends JFrame {
	...
	public TiendaGeometricaPolimorfismo() {
	...
	public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
        	TiendaGeometricaPolimorfismo app = new TiendaGeometricaPolimorfismo();
            app.setVisible(true);
        });
    }
}
